...
embedding_network = "models/resface64_relu_m.py"
...
# Restore model
restore_model = r'G:\chenkai\Probabilistic-Face-Embeddings-master\log\resface64_relu_msarcface_am_PFE\20201022-104812-mls1.0-abs1e-3'
